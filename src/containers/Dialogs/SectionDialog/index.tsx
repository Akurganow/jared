...
export default function SectionDialog() {
	...
	const isDisabled = useMemo(() => isEqual(editingItem, updatedItem), [editingItem, updatedItem])
	...
	return (
		<Dialog name="section" onCloseComplete={handleCloseComplete} style={{ minWidth: '40rem' }}>
			<DialogBody>{updatedItem ? <SectionSettings item={updatedItem} onChange={handleChange} /> : null}</DialogBody>
			<DialogFooter>
