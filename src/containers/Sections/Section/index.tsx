	...
	switch (type) {
		case 'container': {
			...
			return (
				...
				>
					{items.map((item) => (
						<Section id={item} key={item} style={itemStyle} />
					))}
				</SectionItem>
			)
		}
		case 'vcs': {
			return <VCSSection {...props} withTitle={editMode} id={id} sectionStyle={style} sectionClassName={className} />
		}
		case 'its': {
			return <ITSSection {...props} withTitle={editMode} id={id} sectionStyle={style} sectionClassName={className} />
		}
		case 'history': {
			return (
				<HistorySection {...props} withTitle={editMode} id={id} sectionStyle={style} sectionClassName={className} />
			)
		}
		case 'bookmarks': {
			return (
				<BookmarksSection {...props} withTitle={editMode} id={id} sectionStyle={style} sectionClassName={className} />
			)
		}
		default:
			return null
