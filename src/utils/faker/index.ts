export { default as Domain } from 'utils/faker/domain'
export { default as History } from 'utils/faker/history'
export { default as Project } from 'utils/faker/project'
...
import { default as Project } from 'utils/faker/project'
